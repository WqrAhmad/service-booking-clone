  ...
  <div class="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
    <div class=" mx-auto">
      ...
      <div class="mb-8 flex justify-between items-center">
        ...
        <button v-if="canAddService" @click="openCreateModal"
      ...
      <div class="bg-white rounded-lg shadow overflow-hidden">
              ...
              <tr>
                ...
                <th @click="sortTable('price')"
                  ...
                  <div class="flex items-center">
                    Price
                    <span class="ml-2">
                      <svg v-if="sortBy === 'price' && orderBy === 'asc'" class="w-4 h-4" fill="currentColor"
                        viewBox="0 0 20 20">
                        <path
                          d="M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L10 6.414l-3.293 3.293a1 1 0 01-1.414 0z" />
                      </svg>
                      <svg v-else-if="sortBy === 'price' && orderBy === 'desc'" class="w-4 h-4" fill="currentColor"
                        viewBox="0 0 20 20">
                        <path
                          d="M14.707 10.293a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 111.414-1.414L10 13.586l3.293-3.293a1 1 0 011.414 0z" />
                      </svg>
                ...
                <th @click="sortTable('is_active')"
                  class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 select-none">
                  <div class="flex items-center">
                    Status
                    <span class="ml-2">
                      <svg v-if="sortBy === 'is_active' && orderBy === 'asc'" class="w-4 h-4" fill="currentColor"
                        viewBox="0 0 20 20">
                        <path
                          d="M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L10 6.414l-3.293 3.293a1 1 0 01-1.414 0z" />
                      </svg>
                      <svg v-else-if="sortBy === 'is_active' && orderBy === 'desc'" class="w-4 h-4" fill="currentColor"
                        viewBox="0 0 20 20">
                        <path
                          d="M14.707 10.293a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 111.414-1.414L10 13.586l3.293-3.293a1 1 0 011.414 0z" />
                      </svg>
                ...
                <th @click="sortTable('created_at')"
                  ...
                  <div class="flex items-center">
                    Created
                    <span class="ml-2">
                      <svg v-if="sortBy === 'created_at' && orderBy === 'asc'" class="w-4 h-4" fill="currentColor"
                        viewBox="0 0 20 20">
                        <path
                          d="M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L10 6.414l-3.293 3.293a1 1 0 01-1.414 0z" />
                      </svg>
                      <svg v-else-if="sortBy === 'created_at' && orderBy === 'desc'" class="w-4 h-4" fill="currentColor"
                        viewBox="0 0 20 20">
                        <path
                          d="M14.707 10.293a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 111.414-1.414L10 13.586l3.293-3.293a1 1 0 011.414 0z" />
                      </svg>
              ...
              <tr v-for="service in serviceList.data" :key="service.id" class="hover:bg-gray-50">
                ...
                <td class="px-2 py-4 whitespace-nowrap text-sm font-medium">
                  <div class="relative inline-block actions-dropdown">
                    <button type="button" @click.stop="toggleActionsDropdown(service.id)"
                    ...
                    <div v-if="actionsOpenId === service.id"
                      ...
                      <button v-if="canEditService" type="button" @click.stop="closeAndRun(() => editService(service))"
                        class="block w-full text-left px-4 py-2 text-sm text-blue-600 hover:bg-blue-50">
                        Edit
                      </button>
                      <button v-if="canDeleteService" type="button"
        ...
        <!-- Pagination -->
        <div v-if="!listLoading && serviceList.data && serviceList.data.length > 0"
          ...
          <div class="flex items-center justify-between">
            <div class="flex-1 flex justify-between sm:hidden">
              ...
              <button @click="nextPage" :disabled="page >= serviceList.last_page"
    ...
    <!-- Service Modal -->
    <ServiceModal ref="serviceModalRef" :is-visible="showModal" :edit-data="editingService" @close="closeModal"
