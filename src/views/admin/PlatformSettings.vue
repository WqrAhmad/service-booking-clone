    ...
    <div class=" mx-auto">
      ...
      <div v-if="!loading" class="bg-white rounded-lg shadow-xl p-8">
            ...
            <div class="space-y-6">
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div class="flex items-center gap-4">
                    <input id="favicon" v-model="settings.favicon" type="text"
                      ...
                      placeholder="Enter favicon URL or upload file" :disabled="faviconFile !== null" />
                    <input ref="faviconFileInput" type="file" accept="image/x-icon,image/png,image/jpeg"
                      @change="handleFaviconUpload" class="hidden" />
                    <button type="button" @click="faviconFileInput?.click()"
                  ...
                  <div v-if="faviconPreview || settings.favicon" class="mt-2 flex items-center gap-2">
                    ...
                    <button v-if="faviconFile" type="button" @click="clearFavicon"
                ...
                <div>
                  ...
                  <div class="flex items-center gap-4">
                    <input id="logo" v-model="settings.logo" type="text"
                      class="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
                      placeholder="Enter logo URL or upload file" :disabled="logoFile !== null" />
                    <input ref="logoFileInput" type="file" accept="image/png,image/jpeg,image/svg+xml"
                  ...
                  <div v-if="logoPreview || settings.logo" class="mt-2 flex items-center gap-2">
                    <img :src="logoPreview || settings.logo" alt="Logo"
                    ...
                    <button v-if="logoFile" type="button" @click="clearLogo"
                      class="text-sm text-red-600 hover:text-red-700">
                      Remove
                    </button>
                  </div>
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input id="logoWidth" v-model.number="settings.logo_width" type="number"
                ...
                <div>
                  ...
                  <input id="logoHeight" v-model.number="settings.logo_height" type="number"
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
                    placeholder="50" />
                </div>
              </div>
            ...
            <div class="space-y-6">
              <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <input id="title" v-model="settings.title" type="text"
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
                ...
                <div>
                  ...
                  <input id="phone" v-model="settings.phone" type="text"
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
              ...
              <div>
                ...
                <textarea id="address" v-model="settings.address" rows="3"
                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
        ...
        <div class="border-t border-gray-200 border-dashed pt-5 mt-5">
          ...
          <QuillEditor id="terms" v-model:content="terms.content" content-type="html" theme="snow" toolbar="full"
        ...
        <div class="pt-6 border-t border-gray-200">
          <button @click="handleSubmitTerms" :disabled="savingTerms"
            class=" bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-3 px-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed">
