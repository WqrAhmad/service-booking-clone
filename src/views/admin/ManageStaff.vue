<template>
    ...
    <div class=" mx-auto">
      ...
      <div class="mb-8 flex justify-between items-center">
        <div>
          ...
          <p class="text-gray-600 mt-2">Create and manage staff members</p>
        </div>
        <button
          v-if="canAddStaff"
        ...
        <div v-else class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
              <tr>
                <th 
                  @click="sortTable('role_id')"
                  class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 select-none"
                >
                  <div class="flex items-center">
                 Role
                    <span class="ml-2">
                      <svg v-if="sortBy === 'role_id' && orderBy === 'asc'" class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L10 6.414l-3.293 3.293a1 1 0 01-1.414 0z"/>
                      </svg>
                      <svg v-else-if="sortBy === 'role_id' && orderBy === 'desc'" class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                ...
                >
                  <div class="flex items-center">
                    Status
                    <span class="ml-2">
                      <svg v-if="sortBy === 'status' && orderBy === 'asc'" class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L10 6.414l-3.293 3.293a1 1 0 01-1.414 0z"/>
                      </svg>
                      <svg v-else-if="sortBy === 'status' && orderBy === 'desc'" class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M14.707 10.293a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 111.414-1.414L10 13.586l3.293-3.293a1 1 0 011.414 0z"/>
                      </svg>
                      <svg v-else class="w-4 h-4 text-gray-300" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M5 10a1 1 0 011-1h8a1 1 0 110 2H6a1 1 0 01-1-1z"/>
  ...
  >
    {{ staff.status === 'active' ? 'Active' : 'Inactive' }}
        ...
        <!-- Pagination -->
        <div v-if="!listLoading && staffList.data && staffList.data.length > 0" class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
          <div class="flex items-center justify-between">
            ...
            <div class="flex-1 flex justify-between sm:hidden">
              ...
              <button
                @click="nextPage"
                :disabled="page >= staffList.meta?.last_page"
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              ...
              <div>
                <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                  ...
                  <button
                    @click="nextPage"
                    :disabled="page >= staffList.last_page"
...
>
  <!-- Modal panel -->
  <div class="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:max-w-lg w-full mx-4">
    <!-- Header -->
    ...
    <div class="bg-white px-6 py-5">
      ...
      <div>
        ...
        <div v-if="selectedStaff?.permissions && selectedStaff.permissions.length > 0" class="space-y-2 max-h-64 overflow-y-auto">
          <div
            v-for="permission in selectedStaff.permissions"
            :key="permission.id"
