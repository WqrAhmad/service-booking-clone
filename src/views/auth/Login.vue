      ...
      <div class="bg-white rounded-lg shadow-xl p-8">
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div>
            ...
            <input id="email" v-model="formData.login" type="email" :class="[
            ...
            ]" placeholder="Enter your email address" @blur="validateEmail" @input="errors.login = ''" />
          ...
          <div>
            ...
            <div class="relative">
              <input id="password" v-model="formData.password" :type="showPassword ? 'text' : 'password'" :class="[
                'w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all',
